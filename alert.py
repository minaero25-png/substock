...
def main():
    ...
    if expired:
        ...
        for i in expired:
            msg += f"  • {i['name']}\n"
            msg += f"    Lot: {i['lot']} | <b><u>Exp: {i['exp']} ({abs(i['days'])} วันที่แล้ว!)</u></b>\n"
    ...
    if urgent:
        ...
        for i in urgent:
            msg += f"  • {i['name']}\n"
            msg += f"    Lot: {i['lot']} | <b><u>Exp: {i['exp']} (⚠️ อีก {i['days']} วัน!)</u></b>\n"
            msg += f"    คงเหลือ: {i['qty']} | {i['type']}\n"
    ...
    if warning:
        ...
        for i in warning:
            msg += f"  • {i['name']}\n"
            msg += f"    Lot: {i['lot']} | <b><u>Exp: {i['exp']} (อีก {i['days']} วัน)</u></b>\n"
